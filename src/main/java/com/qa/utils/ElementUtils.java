...
public class ElementUtils extends PageFactory
{
	...
	public static void clickOrFail(By element, String failMessage)
	{
		...
		catch (Exception e) 
		{
			...
			LogUtils.log.error("Unable to click on : "+element);
			//LogUtils.reportFail(failMessage+" because of "+e.getClass());
			LogUtils.reportFail(failMessage+"<details>" + "<summary>" + "<b>" + "<font color=" + "red>" + "Exception Occured: Click here to see the full error" + "</font>" + "</b >" + "</summary>" + e.getMessage()+ "</details>" + " \n");
		}
	}
	...
	public static void sendKeyOrFail(By element, String failMessage, String...textToBeFilled)
	{
		...
		catch (Exception e) 
		{
			...
			LogUtils.log.error("Unable to fill in : "+element);
			LogUtils.reportFail(failMessage+"<details>" + "<summary>" + "<b>" + "<font color=" + "red>" + "Exception Occured:Click to see" + "</font>" + "</b >" + "</summary>" + e.getMessage()+ "</details>" + " \n");
		}
	}
	...
	public  static void selectByVisibleTextOrFail(By element, String textToBeSelected, String failMessage)
	{
		...
		catch (Exception e) 
		{
			...
			LogUtils.log.error("Unable to select : "+element);
			LogUtils.reportFail(failMessage+"<details>" + "<summary>" + "<b>" + "<font color=" + "red>" + "Exception Occured:Click to see" + "</font>" + "</b >" + "</summary>" + e.getMessage()+ "</details>" + " \n");
		}
	}
